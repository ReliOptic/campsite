...
10항 중 9항 완전 준수, 1항(텍스트 절단)은 본체 통합 시 max-width 또는 행 분할로 해소.
...
- [ ] Step 1 — `design/system/tokens.css` 권위 사본 분리
- [ ] Step 2 — pixel-art.css 채택 + 동물 sprite manifest 분리
- [ ] Step 3 — camp_render 분해 + 3 화면 템플릿 도입
- [ ] Step 4 — Tweaks 제거, Drawer는 vanilla JS로 변환
- [ ] Step 5 — camp-serve-poll.js 데이터 schema 보강
- [ ] Step 6 — 회귀 테스트 보강
- [ ] M3 산출물 후속 발주 (768px 폴백, 모션 사양 JSON, 매니페스트)
